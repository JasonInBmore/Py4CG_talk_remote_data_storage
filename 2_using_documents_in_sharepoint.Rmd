...
The following code would work better in a function but is presented line-by-line for the example. In the example, the file is temporarily downloaded from sharepoint, then read into memory before being deleted. It uses the connection established above.
