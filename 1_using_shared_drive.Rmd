...
In the Mayor's Office office, we call it the "shared drive" but I think it's more commonly called a "Network Drive". These are folders that can be setup and shared within an office or agency. They aren't on an individually computer (they're on a server) but they look like a native folder after they're [mapped](https://support.microsoft.com/en-us/windows/map-a-network-drive-in-windows-29ce55d1-34e3-a7e2-4801-131475f9557d).
