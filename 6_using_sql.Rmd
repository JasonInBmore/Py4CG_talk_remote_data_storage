...
The server info is best saved as an environmental variable but it can come in the form of an IP address or a url-like string. You'll need a user ID and password as well. Depending on where and how the database is hostied, you might also need to be an the network.
